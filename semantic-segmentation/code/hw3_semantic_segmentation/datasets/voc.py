...
class VOCSegmentation(data.Dataset):
    ...
    def decode_target(cls, mask):
        ...
        for i,value in enumerate(color_map):
          # print(i,value)
          mask_idx = (mask == i)
          rgb_mask[mask_idx] = value
        # print(mask)
...
# voc = VOCSegmentation('data')
# img, mask = voc[0]
# fig, axes = plt.subplots(1, 2)
# axes[0].imshow(img)
# axes[1].imshow(mask)
# plt.savefig("test1_1_1.png")

# mask = Image.open("data/VOCdevkit/VOC2012/SegmentationClass/2007_000032.png")  # Replace "sample_mask.png" with the path to your segmentation mask
# mask = voc.decode_target(mask)
# mask.save('test1_1_2.png')
