...
### 1) Face Detection: Anchor-based Detector (Backbone + FPN + Multi-head)
...
### 2) Semantic Segmentation: DeepLabV3/V3+ from Core Blocks
...
### 3) GAN Image Generation: DCGAN + Training Stabilization
...
### 4) Image Classification: MNIST / CIFAR-100 + Fine-tuning + t-SNE
...
- ### 5) FollowMe: Assistive Perception (Detection + Depth + Audio)
