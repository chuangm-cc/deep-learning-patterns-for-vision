...
### 1) FollowMe: Assistive Perception (Detection + Depth + Audio)
...
### 2) Face Detection: Anchor-based Detector (Backbone + FPN + Multi-head)
...
### 3) Semantic Segmentation: DeepLabV3/V3+ from Core Blocks
...
### 4) GAN Image Generation: DCGAN + Training Stabilization
...
### 5) Image Classification: MNIST / CIFAR-100 + Fine-tuning + t-SNE
